...
1. Remove the USB/audio interface connectors. There ard **3 clamps** to remove. 1 small, 2 large. Each one rests on a metal hook. Be careful that you don't lose them as you unscrew!  (_Image 1_, circled in <span className="font-bold text-[#D81B60]">Pink</span>)
...
1. Cable 2 (right) has a plastic housing covering it. Remove that, And then use a spudge to ease the cable out. (_Image 2_, circled in <span className="font-bold text-[#D81B60]">Pink</span>) 
