...
export const WorkInProgress = () => (
  <div className="wip mb-5 px-4 py-px bg-[repeating-linear-gradient(45deg,_blue_0,_blue_1px,_transparent_0,_transparent_50%)] bg-[size:10px_10px] bg-fixed border-blue-500">
